// src/components/WindmillNacelle.tsx
...
export default function WindmillNacelle({ 
  ...
  useFrame(({ clock }, delta) => {
    ...
    if (lightMeshRef.current) {
      (lightMeshRef.current.material as THREE.MeshStandardMaterial).emissiveIntensity = intensity * 2;
    }
  ...
  const handleHover = (name: string, object: THREE.Object3D) => {
