...
const generateMockAlerts = (): Alert[] => {
  ...
  const possibleAlerts = [
    { type: 'warning' as const, message: 'Blade vibration approaching threshold', module: 'maintenance' as const },
    { type: 'info' as const, message: 'Scheduled maintenance due in 7 days', module: 'maintenance' as const },
    { type: 'error' as const, message: 'Power output below expected for current wind conditions', module: 'power' as const },
    { type: 'info' as const, message: 'Weather conditions optimal for operation', module: 'weather' as const },
  ];
